import { FETCH_POSTS, CREATE, LIKE, UPDATE, DELETE,COMMENT, DELETE_COMMENT, FETCH_POST_BY_SEARCH, FETCH_RELATED_POSTS, FETCH_POST_BY_ID, POST_LOADING } from '../actions/actionTypes';
